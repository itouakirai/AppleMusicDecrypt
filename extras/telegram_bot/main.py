...
# Add project root to sys.path to allow execution via `uv run python extras/telegram_bot/main.py`
...
from src.wrapper import WMCreator
...
from extras.telegram_bot.src.handlers.admin import whitelist_handler, blacklist_handler, gstatus_handler
...
async def post_init(app):
    ...
    await it(WrapperManager).init(url)
